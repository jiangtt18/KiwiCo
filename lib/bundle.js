...
function click(button) {
  button.onclick = function () {
    console.log(__WEBPACK_IMPORTED_MODULE_0__util_js__["a" /* comments */]);
  };
}
...
const comments = {
  ...
  educational: ["My daughter is a sponge for STEM projects​ and this is the perfect solution to constantly searching for new things to keep her engaged.", "", "http://icdn.kiwicrate.com/site/home/why-kiwico-educational.jpg"],
